...
#ifndef PDFVIEWER_ABSTRACTINFODOCK_H
#define PDFVIEWER_ABSTRACTINFODOCK_H
...
public:
    ...
    /*virtual*/ void pageChanged(double page, PdfView::PositionHandling keepPosition);
...
#endif // PDFVIEWER_ABSTRACTINFODOCK_H
