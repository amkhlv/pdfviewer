...
QString DocumentObserver::fileName() const
{
	return m_viewer->m_file;
}

Poppler::Document* DocumentObserver::document() const
{
    return m_viewer->document();
}

void DocumentObserver::setPage(double page, PdfView::PositionHandling keepPosition)
{
    m_viewer->setPage(page, keepPosition);
}
